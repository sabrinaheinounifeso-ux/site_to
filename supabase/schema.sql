...
values
  ...
  ('PERFIL_TO', 'Perfil de TO',
   ...
   array['[preencher no painel admin — mesma equipe da Coordenação]'],
   'https://instagram.com/perfil.to.exemplo', '[preencher — mesmo WhatsApp da Coordenação]', 'coordenacao.to@exemplo.edu.br',
   '[preencher localização]', '[preencher horário de atendimento]',
  ...
  ('COORDENACAO', 'Coordenação do Curso',
   ...
   array['eventos de integração','divulgação de conteúdo (é o mesmo contato, mas o destino certo é o Perfil de TO)'],
   array['[preencher no painel admin]'],
   null, '[preencher — mesmo WhatsApp do Perfil de TO]', 'coordenacao.to@exemplo.edu.br',
   '[preencher localização]', '[preencher horário de atendimento]',
